...
//     const response=await axios.get(`${API_URL}/api/admin/products`,async()=>{
//         headers:{
...
// //async thnk to update an existing rpoduct
...
// export const deletProduct=createAsyncThunk('adminProducts/deleteProduct',async(id)=>{
//     await axios.delete(`${API_URL}/apie/products/${id}`,{
//         headers:{
//             Authorization:USER_TOKEN,
//         }
//     })
...
const USER_TOKEN = token ? `Bearer ${token}` : "";
