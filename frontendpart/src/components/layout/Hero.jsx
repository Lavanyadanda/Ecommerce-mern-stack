...
//                 <h1 className='text-4xl md:text-9xl font-bold tracking-tighter uppercase mb-4'>  Vacation <br> Ready</br></h1>
...
const Hero = () => {
  return (
    <section className='relative'> 
        <img src={heroImg} className='w-full h-[400px] md:h-[600px] lg:h-[750px] object-cover' alt="Hero" />
